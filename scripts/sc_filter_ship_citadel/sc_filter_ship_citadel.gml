function sc_filter_ship_citadel(){

for(var _i=0;_i<=ship_number;_i++) {ship_citadel_result[ship_tier,_i] = "CITADEL";}
	

var _main = ship_citadel;
var _result = ship_citadel_result;
	...
	var _z = _low + _per *-1;
		...
		//----FILTERS-----
		filter_ship_citadel = -1;
		filter_ship_citadel_low = _low;
		filter_ship_citadel_high = _high;
		filter_ship_citadel_per = _per;
