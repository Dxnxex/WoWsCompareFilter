function sc_filter_ship_turn(){

for(var _i=0;_i<=ship_number;_i++) {ship_turn_result[ship_tier,_i] = "turn";}
	

var _main = ship_turn;
var _result = ship_turn_result;
	...
	var _z = _low + _per *-1;
		...
		//----FILTERS-----
		filter_ship_turn = -1;
		filter_ship_turn_low = _low;
		filter_ship_turn_high = _high;
		filter_ship_turn_per = _per;
