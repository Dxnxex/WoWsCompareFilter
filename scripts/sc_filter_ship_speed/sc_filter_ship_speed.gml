function sc_filter_ship_speed(){

for(var _i=0;_i<=ship_number;_i++) {ship_speed_result[ship_tier,_i] = "SPEED";}
	

var _main = ship_speed;
var _result = ship_speed_result;
	...
	var _z = _low + _per *-1;
		...
		//----FILTERS-----
		filter_ship_speed = -1;
		filter_ship_speed_low = _low;
		filter_ship_speed_high = _high;
		filter_ship_speed_per = _per;
