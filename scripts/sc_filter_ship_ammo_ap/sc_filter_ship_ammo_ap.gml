function sc_filter_ship_ammo_ap(){

for(var _i=0;_i<=ship_number;_i++) {ship_ap_result[ship_tier,_i] = "firerate";}
	

var _main = ship_ap;
var _result = ship_ap_result;
	...
	var _z = _low + _per *-1;
		...
		//----FILTERS-----
		filter_ship_ap = -1;
		filter_ship_ap_low = _low;
		filter_ship_ap_high = _high;
		filter_ship_ap_per = _per;
