function sc_filter_ship_detection(){

for(var _i=0;_i<=ship_number;_i++) {ship_detection_result[ship_tier,_i] = "detection";}
	

var _main = ship_detection;
var _result = ship_detection_result;
	...
	var _z = _low + _per *-1;
		...
		//----FILTERS-----
		filter_ship_detection = -1;
		filter_ship_detection_low = _low;
		filter_ship_detection_high = _high;
		filter_ship_detection_per = _per;
