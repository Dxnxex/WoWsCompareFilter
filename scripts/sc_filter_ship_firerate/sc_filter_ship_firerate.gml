function sc_filter_ship_firerate(){

for(var _i=0;_i<=ship_number;_i++) {ship_firerate_result[ship_tier,_i] = "firerate";}
	

var _main = ship_firerate;
var _result = ship_firerate_result;
	...
	var _z = _low + _per *-1;
		...
		//----FILTERS-----
		filter_ship_firerate = -1;
		filter_ship_firerate_low = _low;
		filter_ship_firerate_high = _high;
		filter_ship_firerate_per = _per;
