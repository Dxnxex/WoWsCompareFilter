function sc_filter_ship_ammo_he(){

for(var _i=0;_i<=ship_number;_i++) {ship_he_result[ship_tier,_i] = "firerate";}
	

var _main = ship_he;
var _result = ship_he_result;
	...
	var _z = _low + _per *-1;
		...
		//----FILTERS-----
		filter_ship_he = -1;
		filter_ship_he_low = _low;
		filter_ship_he_high = _high;
		filter_ship_he_per = _per;
