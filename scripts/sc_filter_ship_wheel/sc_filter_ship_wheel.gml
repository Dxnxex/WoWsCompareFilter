function sc_filter_ship_wheel(){

for(var _i=0;_i<=ship_number;_i++) {ship_wheel_result[ship_tier,_i] = "Wheel";}
	

var _main = ship_wheel;
var _result = ship_wheel_result;
	...
	var _z = _low + _per *-1;
		...
		//----FILTERS-----
		filter_ship_wheel = -1;
		filter_ship_wheel_low = _low;
		filter_ship_wheel_high = _high;
		filter_ship_wheel_per = _per;
